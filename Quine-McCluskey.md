...
<div style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23); padding: 20px; border-radius: 5px;">
<h1 align="center">
...
O algoritmo de Quine-McCluskey (ou método dos primos implicantes) é um método utilizado para realizar a minimização de funções Booleanas que foi desenvolvido por Willard V. Quine e melhorado por Edward J. McCluskey.<br>

O algoritmo é funcionamelte igual ao Mapa de Karnaugh mas a sua forma tabular o torna mais eficiente para o uso em algoritmos computacionais.
</div>

<div style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23); margin-top: 20px; padding: 20px; border-radius: 5px;">
<h2 align="center">
Exemplo Prático
</h2>
...
<h3 align="center">
Número de Váriaveis $N[\alpha]$ :
</h3>

<variable-slider label=" " min="0" max="100" step="1">n_var</variable-slider>
<variable-number label="N$[\alpha]$ :" min="0" max="100" step="1">n_var</variable-number>

<h3 align="center">
Mintermos $P(A,B,C,D\dots)$:
</h3>

<variable-string label="Insira os Mintermos Separados por Espaço" placeholder="1 2 3 5...">minterms</variable-string>

<section-button value="Calcular">
...
display(Markdown('<h3>Implicações</h3>'))
s = ""
for i in unchecked:
...
display(Markdown('<h3>Respostas</h3>'))
...
<img src="https://proxy.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.infoescola.com%2Fwp-content%2Fuploads%2F2017%2F11%2FMarca-Cesar-School-02-600x424.png&f=1" alt="drawing" width="150"/>